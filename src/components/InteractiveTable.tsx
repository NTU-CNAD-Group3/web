...
function InteractiveTable() {
  ...
  const [items, setItems] = useState<Item[]>([
    ...
    },
    {
      ...
      description:
        "Meeting with key stakeholders to discuss project progress and gather feedback on recent feature implementations.",
    },
    {
      id: "005",
      name: "Product Launch",
        ...
        <div className="md:col-span-1">
          {isEditing || isAdding ? (
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-2">Date: {viewedItem.time}</p>
