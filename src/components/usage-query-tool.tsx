      ...
      {selectedServer && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Detailed information for {servers.find((server) => server.id === selectedServer)?.name}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {(() => {
              ...
              return (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <h4 className="text-sm font-medium mb-1">Server Information</h4>
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <Progress
                              ...
                              className="h-2"
                              indicatorClassName={getProgressColor(server.cpu.usage)}
                            />
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              ...
                              <div className={`text-sm ${getUsageColor(server.memory.usage)}`}>
                                {server.memory.usage}%
                              </div>
                            </div>
                            <Progress
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              ...
                              <div className={`text-sm ${getUsageColor(server.storage.usage)}`}>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              ...
                              <div className={`text-sm ${getUsageColor(server.network.usage)}`}>
