            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="text-red-500 font-medium">92%</div>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="font-medium">DB-SRV-01</div>
                  <div className="text-yellow-500 font-medium">85%</div>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="font-medium">DB-SRV-01</div>
                  <div className="text-red-500 font-medium">95%</div>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="font-medium">WEB-SRV-01</div>
                  <div className="text-yellow-500 font-medium">82%</div>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <div className="font-medium">BACKUP-SRV-01</div>
                  <div className="text-red-500 font-medium">90%</div>
                </div>
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <Progress
          value={value}
          className={`h-2 mt-2 ${alert ? (value > 90 ? "bg-red-100" : "bg-yellow-100") : ""}`}
